...
OverviewTab = (function(_super) {
  ...
  OverviewTab.prototype.dependencies = ['MarcoHabitat', 'SizeToolbox'];

  OverviewTab.prototype.render = function() {
    var context, habitats, size;
    habitats = this.recordSet('MarcoHabitat', 'MarcoHabitats').toArray();
    this.roundData(habitats);
    habitats = _.sortBy(habitats, function(row) {
      return row.Name;
    });
  ...
  OverviewTab.prototype.roundData = function(data) {
    ...
    for (_i = 0, _len = data.length; _i < _len; _i++) {
      d = data[_i];
      try {
        _results.push(d.AREA = parseFloat(d.AREA).toFixed(1));
      } catch (_error) {
        _results.push(d.AREA = 0.0);
      }
    }
    return _results;
  };
